...
for (j in 1:length(alpha_vector)) {
  ...
  for (i in 1:length(h_vector)) {
    h <- h_vector[i]
    time_step <- tau_from_h_exact(h, alpha - epsilon)/divider
    ...
    UU <- sqrt(as.double(overkill_time_step * sum(auxX * (overkill_C %*% auxX)))) / abs(log(time_step))
    
    auxX <- res$P
    auxX <- construct_piecewise_projection(Psi %*% auxX, time_seq, overkill_time_seq)
    auxX <- overkill_p_bar - auxX
    PP <- sqrt(as.double(overkill_time_step * sum(auxX * (overkill_C %*% auxX)))) / abs(log(time_step))
    
    auxX <- res$Z
    auxX <- construct_piecewise_projection(Psi %*% auxX, time_seq, overkill_time_seq)
    auxX <- overkill_z_bar - auxX
    ZZ <- sqrt(as.double(overkill_time_step * sum(auxX * (overkill_C %*% auxX)))) / abs(log(time_step))
...
save(errors_u_bar, errors_p_bar, errors_z_bar, file = here::here("data_files/control_error_h_with_iteration_with_logtau_and_tauminustwo.RData"))
```
...
load(here::here("data_files/control_error_h_with_iteration_with_logtau_and_tauminustwo.RData"))
```
...
p_u_bar_with_logtau_and_tauminustwo <- error.convergence.plotter(x_axis_vector = h_vector, 
                               alpha_vector, 
                               errors_u_bar, 
                               theoretical_rates, 
...
p_p_bar_with_logtau_and_tauminustwo <- error.convergence.plotter(x_axis_vector = h_vector, 
                               alpha_vector, 
                               errors_p_bar, 
                               theoretical_rates, 
...
p_z_bar_with_logtau_and_tauminustwo <- error.convergence.plotter(x_axis_vector = h_vector, 
                               alpha_vector, 
                               errors_z_bar, 
                               theoretical_rates, 
...
p_h_u_with_logtau_and_tauminustwo <- error.convergence.plotter(x_axis_vector = h_vector, 
                               alpha_vector, 
                               errors_u_bar, 
                               theoretical_rates, 
                               observed_rates_u_bar,
...
p_h_u_nicer_tadpole_with_logtau_and_tauminustwo <- errorConvergencePlotterLatex(x_axis_vector = h_vector, 
                                 alpha_vector, 
                                 errors_u_bar, 
                                 theoretical_rates, 
                                 observed_rates_u_bar,
...
p_h_z_with_logtau_and_tauminustwo <- error.convergence.plotter(x_axis_vector = h_vector, 
                               alpha_vector, 
                               errors_z_bar, 
                               theoretical_rates, 
                               observed_rates_z_bar,
...
p_h_z_nicer_tadpole_with_logtau_and_tauminustwo <- errorConvergencePlotterLatex(x_axis_vector = h_vector, 
                                 alpha_vector, 
                                 errors_z_bar, 
                                 theoretical_rates, 
                                 observed_rates_z_bar,
...
p_all_h_with_logtau_and_tauminustwo <- (p_u_bar_with_logtau_and_tauminustwo | p_p_bar_with_logtau_and_tauminustwo | p_z_bar_with_logtau_and_tauminustwo) + 
  plot_annotation(
...
myggsave(p_h_u_nicer_tadpole_with_logtau_and_tauminustwo, width = 4, height = 5, use_mathpazo = TRUE)
save(p_h_u_nicer_tadpole_with_logtau_and_tauminustwo, file = here::here("data_files/p_h_u_nicer_tadpole_with_logtau_and_tauminustwo.RData"))

myggsave(p_h_z_nicer_tadpole_with_logtau_and_tauminustwo, width = 4, height = 5, use_mathpazo = TRUE)
save(p_h_z_nicer_tadpole_with_logtau_and_tauminustwo, file = here::here("data_files/p_h_z_nicer_tadpole_with_logtau_and_tauminustwo.RData"))

save(p_h_u_with_logtau_and_tauminustwo, file = here::here("data_files/p_h_u_with_logtau_and_tauminustwo.RData"))
save(p_h_z_with_logtau_and_tauminustwo, file = here::here("data_files/p_h_z_with_logtau_and_tauminustwo.RData"))

ggsave(here::here("data_files/control_conv_rates_h_all_with_iteration_with_logtau_and_tauminustwo.png"), width = 12, height = 6, plot = p_all_h_with_logtau_and_tauminustwo, dpi = 300)
```

```{r, eval = TRUE, fig.align='center', fig.dim= c(12,6), fig.cap = captioner("Comparison of theoretical and observed convergence behavior for the $L_2((0,T);L_2(\\Gamma))$-error with respect to $h$ on a $\\text{log}_{10}$–$\\text{log}_{10}$ scale. Dashed lines indicate the theoretical rates, and solid lines represent the observed error curves. The legend below each plot shows the value of $\\alpha$ along with the corresponding theoretical ('theo'), and observed ('obs') rates for each case.")}
...
knitr::include_graphics(here::here("data_files/control_conv_rates_h_all_with_iteration_with_logtau_and_tauminustwo.png"))
```
...
# option 1
slackr_upload(
  filename = "data_files/control_conv_rates_h_all_with_iteration_with_logtau_and_tauminustwo.png",        # path to your image

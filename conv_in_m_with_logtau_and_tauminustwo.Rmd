...
```{r}
load(here::here("data_files/errors_projected_m_with_logtau_and_tauminustwo.RData"))
```
...
knitr::include_graphics(here::here("data_files/tikzpic/p_m_nicer_tadpole_with_logtau_and_tauminustwo_with_mathpazo.pdf"))
```

...
knitr::include_graphics(here::here("data_files/control_conv_rates_h_all.png"))
```
...
knitr::include_graphics(here::here("data_files/control_conv_rates_tau_all.png"))
```
...
knitr::include_graphics(here::here("data_files/control_conv_rates_m_all.png"))
```    
...
p_all_z
ggplot2::ggsave(here::here("data_files/p_all.png"), width = 12, height = 5, plot = p_all_z, dpi = 300)
```

...
## Optimal solution {#num_scheme_optim_control}
...
## Convergence analysis of the FBSM iteration
...
## Compares $\gamma$ and its upper bound $1/(\mu \kappa^{4 \beta})$ {#contraction_constant_comparison}

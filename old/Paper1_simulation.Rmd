...
# Parameters
sigma <- readRDS(here::here("old/sigma.RDS")) #1.7
range <- readRDS(here::here("old/range.RDS")) #0.3
nu <- readRDS(here::here("old/nu.RDS")) #0.8
rspde.order <- 2
...
n.rep <- readRDS(here::here("old/n_rep.RDS")) #2
u.rep <- simulate(op, nsim = n.rep)

obs.per.edge <- floor(400/(n.rep*graph$nE))
obs.loc <- NULL
for(i in 1:graph$nE) {
...
sigma.e <- readRDS(here::here("old/sigma_e.RDS")) #0.1

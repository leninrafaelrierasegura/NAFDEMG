...
p_h_tadpole <- error.convergence.plotter(x_axis_vector = h_vector, 
                                 alpha_vector, 
                                 errors_projected, 
                                 theoretical_rates, 
                                 observed_rates,
...
ggsave(here::here("data_files/conv_rates_h_tadpole_with_logtau.png"), width = 4, height = 5, plot = p_h_tadpole, dpi = 300)
myggsave(p_h_nicer_tadpole_with_logtau, width = 4, height = 5, use_mathpazo = TRUE)
save(p_h_tadpole, file = here::here("data_files/p_h_tadpole_with_logtau.RData"))

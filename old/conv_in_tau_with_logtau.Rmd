...
ggsave(here::here("data_files/conv_rates_tau_tadpole_with_logtau.png"), width = 4, height = 5, plot = p_tau_tadpole, dpi = 300)
myggsave(p_tau_nicer_tadpole_with_logtau, width = 4, height = 5, use_mathpazo = TRUE)
save(p_tau_tadpole, file = here::here("data_files/p_tau_tadpole_with_logtau.RData"))

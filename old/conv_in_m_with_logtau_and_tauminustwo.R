...
dividerh_vector <- c(1, 2, 3, 5, 7, 9)
dividertau_vector <- c(1, 2, 3, 5, 7, 9)
...
save(errors_projected, file = here::here("data_files/errors_projected_m_with_logtau_and_tauminustwo.RData"))
...
p_m_nicer_tadpole_with_logtau_and_tauminustwo <- errorConvergencePlotterLatex(x_axis_vector = m_vector, 
                                 alpha_vector, 
                                 errors_projected, 
                                 theoretical_rates, 
                                 observed_rates,
...
ggsave(here::here("data_files/conv_rates_m_tadpole_with_logtau_and_tauminustwo.png"), width = 4, height = 5, plot = p_m_tadpole_with_logtau_and_tauminustwo, dpi = 300)
myggsave(p_m_nicer_tadpole_with_logtau_and_tauminustwo, width = 4, height = 5, use_mathpazo = TRUE)
save(p_m_tadpole_with_logtau_and_tauminustwo, file = here::here("data_files/p_m_tadpole_with_logtau_and_tauminustwo.RData"))
save(p_m_nicer_tadpole_with_logtau_and_tauminustwo, file = here::here("data_files/p_m_nicer_tadpole_with_logtau_and_tauminustwo.RData"))
...
# option 1
slackr_upload(
  filename = here::here("data_files/conv_rates_m_tadpole_with_logtau_and_tauminustwo.png"),        # path to your image

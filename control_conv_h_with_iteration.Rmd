...
for (j in 1:length(alpha_vector)) {
  ...
  for (i in 1:length(h_vector)) {
    ...
    slackr_msg(text = paste0("m =", m, ", alpha =", alpha, ", h =", h, ", time_step =", time_step, ", converged = ", res$converged, ", iterations = ", res$iterations, ", error u = ", DDD, ", error p = ", HHH, ", error z = ", KKK, ", range = ", range(- p_bar / mu)), channel = "#research")
  }
}

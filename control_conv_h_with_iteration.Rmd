...
# Parameters
T_final <- 2
kappa <- readRDS("old/kappa.RDS")#16
divider <- readRDS("old/divider.RDS") #1
mu <- 1
a <- - 0.5*1
b <- 0.5*1
...
save(errors_u_bar, errors_p_bar, errors_z_bar, file = here::here("data_files/control_error_h.RData"))
```
...
load(here::here("data_files/control_error_h.RData"))
...
```{r}
# ggsave(here::here("data_files/control_conv_rates_h_u_bar.png"), width = 4, height = 5, plot = p_u_bar, dpi = 300)
# ggsave(here::here("data_files/control_conv_rates_h_p_bar.png"), width = 4, height = 5, plot = p_p_bar, dpi = 300)
# ggsave(here::here("data_files/control_conv_rates_h_z_bar.png"), width = 4, height = 5, plot = p_z_bar, dpi = 300)
ggsave(here::here("data_files/control_conv_rates_h_all.png"), width = 12, height = 6, plot = p_all_h, dpi = 300)
```
...
# option 1
slackr_upload(
  filename = "data_files/control_conv_rates_h_all.png",        # path to your image

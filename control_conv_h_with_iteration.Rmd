...
for (j in 1:length(alpha_vector)) {
  ...
  # minp <- -max(overkill_p_bar) / mu
  # maxp <- -min(overkill_p_bar) / mu
...
p_h_u_nicer_tadpole <- errorConvergencePlotterLatex(x_axis_vector = h_vector, 
                                 alpha_vector, 
                                 errors_u_bar, 
                                 theoretical_rates, 
                                 observed_rates_u_bar,
...
p_h_z_nicer_tadpole <- errorConvergencePlotterLatex(x_axis_vector = h_vector, 
                                 alpha_vector, 
                                 errors_z_bar, 
                                 theoretical_rates, 
                                 observed_rates_z_bar,
...
myggsave(p_h_u_nicer_tadpole, width = 4, height = 5, use_mathpazo = TRUE)
save(p_h_u_nicer_tadpole, file = here::here("data_files/p_h_u_nicer_tadpole.RData"))

myggsave(p_h_z_nicer_tadpole, width = 4, height = 5, use_mathpazo = TRUE)
save(p_h_z_nicer_tadpole, file = here::here("data_files/p_h_z_nicer_tadpole.RData"))

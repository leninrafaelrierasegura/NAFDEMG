...
and 
\begin{align}
\mathbf{P}\mathbf{V}^\top \boldsymbol{\mathfrak{A}} \mathbf{V}\mathbf{P}^\top = 
\begin{bmatrix}
...
That is
\begin{align*}
    \mathbf{P}\mathbf{V}^\top \boldsymbol{\mathfrak{A}}\mathbf{V}\mathbf{P}^\top = \text{blkdiag}(\mathbf{T}(\mu_1), \mathbf{T}(\mu_2), \dots, \mathbf{T}(\mu_{N_h})),
\end{align*}
Now
\begin{align}
\label{chain2}
    \|\boldsymbol{\mathfrak{L}}\|_{\mathbf{C}_{N+1}}   = \tau^2
    \|\boldsymbol{\mathfrak{A}}\|_2 = \tau^2
    \|\mathbf{P}\mathbf{V}^\top \boldsymbol{\mathfrak{A}} \mathbf{V}\mathbf{P}^\top\|_2 = \tau^2 \max_{i = 1,\dots, N_h}\|\mathbf{T}(\mu_i)\|_2= \tau^2\|\mathbf{T}(\omega)\|_2= \tau^2\|\mathbf{T}\|_2.
\end{align}

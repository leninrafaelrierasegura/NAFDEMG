...
coeff_elliptic_g[7] <- 100000
coeff_elliptic_f <- rep(0, adjusted_N_finite)
coeff_elliptic_f[7] <- -10000
...
z_bar_overkill <- pmax(overkill_A, pmin(overkill_B, elliptic_v %*% t(phi)))
f <- overkill_elliptic_u %*% t(psi_prime) + overkill_elliptic_f %*% t(psi) - z_bar_overkill
U_d <- overkill_elliptic_u %*% t(psi) - mu * (overkill_elliptic_v %*% t(phi_prime)) + mu * (overkill_elliptic_g %*% t(phi))
...
res$converged
history <- res$history
history2 <- res$history2
tol_list <- res$tol_list

plot_convergence_history(history, tol_list)
plot_convergence_history(history2, tol_list)
```

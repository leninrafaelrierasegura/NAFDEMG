...
Go back to the [Control Functionality](control_functionality.html) page to see the details of the numerical scheme for solving the optimal control problem \eqref{eq:costfun}-\eqref{control_constraints}.

...
rmd_file <- here::here("control_functionality.Rmd")
hash_file <- here::here("control_functionality.hash")
r_file <- here::here("control_functionality.R")
purl_file <- here::here("purl_log.txt")

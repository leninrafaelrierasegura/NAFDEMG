...
<!-- \begin{bmatrix} -->
<!-- \sum_{k=1}^{N}(\mathbf{R}\mathbf{C})^{2k}   & \sum_{k=1}^{N-1}(\mathbf{R}\mathbf{C})^{2k+1}  & \sum_{k=1}^{N-2}(\mathbf{R}\mathbf{C})^{2k+2} & \cdots  & \sum_{k=1}^{N-(N-1)}(\mathbf{R}\mathbf{C})^{2k+(N-1)}  \\[1mm] -->
<!-- \sum_{k=1}^{N-1}(\mathbf{R}\mathbf{C})^{2k+1} & \sum_{k=1}^{N-1}(\mathbf{R}\mathbf{C})^{2k} & \sum_{k=1}^{N-2}(\mathbf{R}\mathbf{C})^{2k+1} & \cdots & \sum_{k=1}^{N-(N-1)}(\mathbf{R}\mathbf{C})^{2k+(N-2)}  \\[1mm] -->
<!-- \sum_{k=1}^{N-2}(\mathbf{R}\mathbf{C})^{2k+2} & \sum_{k=1}^{N-2}(\mathbf{R}\mathbf{C})^{2k+1} & \sum_{k=1}^{N-2}(\mathbf{R}\mathbf{C})^{2k} & \cdots & \sum_{k=1}^{N-(N-1)}(\mathbf{R}\mathbf{C})^{2k+(N-3)} \\[1mm] -->
<!-- \vdots   & \vdots & \vdots & \ddots & \vdots \\[1mm] -->
<!-- \sum_{k=1}^{N-(N-1)}(\mathbf{R}\mathbf{C})^{2k+(N-1)}   & \sum_{k=1}^{N-(N-1)}(\mathbf{R}\mathbf{C})^{2k+(N-2)}  & \sum_{k=1}^{N-(N-1)}(\mathbf{R}\mathbf{C})^{2k+(N-3)}  & \cdots & \sum_{k=1}^{N-(N-1)}(\mathbf{R}\mathbf{C})^{2k+(N-N)}  -->
<!-- \end{bmatrix} -->
<!-- \end{align} -->

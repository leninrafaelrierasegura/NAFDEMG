...
p_m_u_nicer_tadpole <- errorConvergencePlotterLatex(x_axis_vector = m_vector, 
                                 alpha_vector, 
                                 errors_u_bar, 
                                 theoretical_rates, 
                                 observed_rates_u_bar,
...
p_m_z_nicer_tadpole <- errorConvergencePlotterLatex(x_axis_vector = m_vector, 
                                 alpha_vector, 
                                 errors_z_bar, 
                                 theoretical_rates, 
                                 observed_rates_z_bar,
...
myggsave(p_m_u_nicer_tadpole, width = 4, height = 5, use_mathpazo = TRUE)
save(p_m_u_nicer_tadpole, file = here::here("data_files/p_m_u_nicer_tadpole.RData"))

myggsave(p_m_z_nicer_tadpole, width = 4, height = 5, use_mathpazo = TRUE)
save(p_m_z_nicer_tadpole, file = here::here("data_files/p_m_z_nicer_tadpole.RData"))

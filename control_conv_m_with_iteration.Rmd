...
alpha_vector <- seq(1.8, 1.8, by = 0.2)
```
...
capture.output(
  knitr::purl(
    here::here("control_conv_m_with_iteration.Rmd"),
    output = here::here("old/scripts/control_conv_m_with_iteration.R")
  ),
  file = here::here("old/purl_log_aux.txt")
)

slackr_upload(
  filename = here::here("old/scripts/control_conv_m_with_iteration.R"),
  initial_comment = "Here’s the R script that produced the above plot",
  channels = "#research"
)
```

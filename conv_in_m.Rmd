...
p_m_nicer <- errorConvergencePlotterLatex(x_axis_vector = m_vector, 
                                 alpha_vector, 
                                 errors_projected, 
                                 theoretical_rates, 
                                 observed_rates,
...
# option 1
slackr_upload(
  filename = "data_files/conv_rates_m.png",        # path to your image
  initial_comment = initial_comment,
  channels = "#research"
)
# option 2
# ggslackr(p_m, channels = "#research", initial_comment = initial_comment) # p is a ggplot2 object
# option 3

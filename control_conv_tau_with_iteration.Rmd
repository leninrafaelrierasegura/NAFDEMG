...
save(errors_u_bar, errors_p_bar, errors_z_bar, file = here::here("data_files/control_error_tau_with_iteration.RData"))
```
# Convergence results

```{r}
# Load the errors data
load(here::here("data_files/control_error_tau_with_iteration.RData"))
...
p_tau_u <- error.convergence.plotter(x_axis_vector = tau_vector, 
                               alpha_vector, 
                               errors_u_bar, 
                               theoretical_rates, 
                               observed_rates_u_bar,
...
p_tau_u_nicer_tadpole <- errorConvergencePlotterLatex(x_axis_vector = tau_vector, 
                                 alpha_vector, 
                                 errors_u_bar, 
                                 theoretical_rates, 
                                 observed_rates_u_bar,
...
p_tau_z <- error.convergence.plotter(x_axis_vector = tau_vector, 
                               alpha_vector, 
                               errors_z_bar, 
                               theoretical_rates, 
                               observed_rates_z_bar,
...
p_tau_z_nicer_tadpole <- errorConvergencePlotterLatex(x_axis_vector = tau_vector, 
                                 alpha_vector, 
                                 errors_z_bar, 
                                 theoretical_rates, 
                                 observed_rates_z_bar,
...
myggsave(p_tau_u_nicer_tadpole, width = 4, height = 5, use_mathpazo = TRUE)
save(p_tau_u_nicer_tadpole, file = here::here("data_files/p_tau_u_nicer_tadpole.RData"))

myggsave(p_tau_z_nicer_tadpole, width = 4, height = 5, use_mathpazo = TRUE)
save(p_tau_z_nicer_tadpole, file = here::here("data_files/p_tau_z_nicer_tadpole.RData"))

save(p_tau_u, file = here::here("data_files/p_tau_u.RData"))
save(p_tau_z, file = here::here("data_files/p_tau_z.RData"))

ggsave(here::here("data_files/control_conv_rates_tau_all_with_iteration.png"), width = 12, height = 6, plot = p_all_tau, dpi = 300)
```
...
# option 1
slackr_upload(
  filename = "data_files/control_conv_rates_tau_all_with_iteration.png",        # path to your image

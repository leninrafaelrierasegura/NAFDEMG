...
p_h_nicer <- errorConvergencePlotterLatex(x_axis_vector = h_vector, 
                                 alpha_vector, 
                                 errors_projected, 
                                 theoretical_rates, 
                                 observed_rates,
...
myggsave(p_h_nicer, width = 4, height = 5, use_mathpazo = TRUE)
save(p_h, file = here::here("data_files/p_h.RData"))
save(p_h_nicer, file = here::here("data_files/p_h_nicer.RData"))
```

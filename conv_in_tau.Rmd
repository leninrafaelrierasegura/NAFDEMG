...
p_tau_nicer <- errorConvergencePlotterLatex(x_axis_vector = tau_vector, 
                                 alpha_vector, 
                                 errors_projected, 
                                 theoretical_rates, 
                                 observed_rates,
...
myggsave(p_tau_nicer, width = 4, height = 5, use_mathpazo = TRUE)
save(p_tau, file = here::here("data_files/p_tau.RData"))
save(p_tau_nicer, file = here::here("data_files/p_tau_nicer.RData"))
```
...
# option 1
slackr_upload(
  filename = "data_files/conv_rates_tau.png",        # path to your image
  initial_comment = initial_comment,
  channels = "#research"
)
# option 2
# ggslackr(p_tau, channels = "#research", initial_comment = initial_comment) # p is a ggplot2 object
# option 3

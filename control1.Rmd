...
## Construction of an exact solution to the optimal control problem

We follow the approach in @Glusa2021errorestimates to construct an exact solution to the optimal control problem \eqref{eq:costfun}-\eqref{zz}. The solution to the elliptic problem
\begin{align}

...
h_vector <- 10^seq(log10(0.005), log10(0.1), length.out = 7)
...
save(errors_projected, file = here::here("data_files/new_errors_projected_h.RData"))
```


```{r}
# Load the errors_projected data
load(here::here("data_files/new_errors_projected_h.RData"))
```
...
```{r}
ggsave(here::here("data_files/new_conv_rates_h.png"), width = 4, height = 5, plot = p_h, dpi = 300)
...
# option 1
slackr_upload(
  filename = "data_files/new_conv_rates_h.png",        # path to your image
